...
import DialogListContainer from '../../DialogComponents/DialogListContainer/DialogListContainerHook';
...
import CatalogListContainer from '../../CatalogComponents/CatalogListContainer/CatalogListContainerHook';
...
function Chat(props) {
  ...
  return (
    ...
    >
      ...
      <div className={styles.toggleChat} onClick={() => props.changeShow()}>
