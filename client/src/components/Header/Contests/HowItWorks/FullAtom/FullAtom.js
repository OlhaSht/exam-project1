    ...
    <div class="body" style={customFontStyle}>
          ...
          <div class="header-block">
            <div class="header-content">
              ...
              >
                ...
                <span class="mobile-part">- where everything starts!</span>
              </a>
              <button class="header-button">
                {' '}
                <a href="https://www.atom.com/blog/discover-atom/"></a> Learn
                More
              </button>
            </div>
          </div>
              ...
              <ul class="main-nav">
                <li class="main-nav-li">
                  ...
                  <ul class="main-nav-drop-list">
                    <li class="main-nav-sub-li">
                      <a
                        class="main-nav-sub-link"
                        href="https://www.atom.com/premium-domains-for-sale"
                      >
                  ...
                  <ul class="icon-drop-down">
                    <li class="icon-link">
                      <a class="icon-text" href="https://www.atom.com/login">
                        <i class="fa-solid fa-circle-user icon-nav"></i>Login
                      </a>
                    </li>
                    <li class="icon-link">
                      <a class="icon-text" href="https://www.atom.com/signup">
                        <i class="fa-solid fa-circle-user icon-nav"></i>Singup
                      </a>
                    </li>
                  </ul>
                </div>
                  ...
                  <ul class="icon-drop-down">
                    <li class="icon-link">
                      <a class="icon-text" href="tel:1-877-355-3585">
                        <i class="fa-solid fa-phone icon-nav"></i>(877)355-3585
                      </a>
                    </li>
                    <li class="icon-link">
                      <a class="icon-text" href="">
                        <i class="fa-solid fa-message icon-nav"></i>Chat
                      </a>
                    </li>
                    <li class="icon-link">
                      <a class="icon-text" href="">
                        <i class="fa-solid fa-envelope icon-nav"></i>Email
                      </a>
                    </li>
                    <li class="icon-link">
                      <a class="icon-text" href="">
                        <i class="fa-solid fa-circle-notch icon-nav"></i>Help
                        Desk
                      </a>
                    </li>
                  </ul>
          ...
          <nav class="mobile-main-container-list">
            <div class="mobile-main">
              <div class="mobile-search-container-block">
                <img
                  class="mobile-search-block-img"
                  src={`${CONSTANTS.STATIC_IMAGES_PATH_ATOM}icon-search.svg`}
                  alt="search"
                />
                <input
                  class="mobile-search-block-input"
                  type="text"
                  placeholder="Search Over 200,000+ Premium Names"
                />
                <button class="mobile-search-block-button">
                  <img
                    class="search-img-arrow"
              ...
              <ul class="mobile-main-nav">
                <li
                  class="mobile-main-nav-li accordeon"
                ...
                >
                  ...
                  <ul class="mobile-main-nav-drop-list ">
                    <li class="mobile-main-nav-sub-li">
                      <a
                        class="main-nav-sub-link"
                        href="https://www.atom.com/premium-domains-for-sale"
                      >
                    ...
                    <li class="mobile-main-nav-sub-li">
                      <a
                        class="mobile-main-nav-sub-link"
                        href="https://www.atom.com/premium-domains-for-sale/all/type_of_name/One%20Word"
                      >
                        One Word Domains
                      </a>
      ...
      <section class="ways-container">
        <div class="ways-container-info">
          ...
          <p class="ways-container-subtitle">
      ...
      <div class="questions-container">
        ...
        <section class="questions-paragraph">
          <h4 id="article1" class="questions-paragraph-title">
            Launching A Contest
          </h4>

          <article
            class="questions-paragraph-point accordeon"
            onClick={(e) => e.currentTarget.classList.toggle('active')}
          >
            <h5 class="questions-paragraph-subtitle ">
              How long does it take to start receiving submissions?{' '}
              <svg
                class="paragraph-plus"
                width="14"
                height="14"
                viewBox="0 0 14 14"
                fill="none"
            ...
            <p class="questions-paragraph-text">
          ...
          >
            ...
            <p class="questions-paragraph-text">
              ...
              Australia.). We utilize an advanced rating score algorithm to
              ensure that high quality creatives receive more opportunities to
          ...
          >
            ...
            <p class="questions-paragraph-text border-text">
            ...
            <ul class="questions-paragraph-list">
              <li class="questions-paragraph-li">
                {' '}
          ...
          >
            ...
            <p class="questions-paragraph-text">
              ...
              <a class="paragraph-link" href="/pricing">
                Pricing Page
              </a>{' '}
              for details
            </p>
          ...
          >
            ...
            <p class="questions-paragraph-text">
              ...
              <a class="paragraph-link" href="/pricing.php?bundle-id=4">
                Pricing Page
              </a>
              .
            </p>
          ...
          >
            ...
            <p
              class="questions-paragraph-text accordeon-text"
              onClick={(e) => e.currentTarget.classList.toggle('active')}
            >
          ...
          >
            ...
            <p class="questions-paragraph-text border-text">
              ...
              Names, Taglines, and Logos that were submitted in recent contests.
            </p>
            <ul>
              <li class="questions-paragraph-li">
                <a class="paragraph-link" href="">
                  Name Examples
                </a>
              </li>
              <li class="questions-paragraph-li">
        ...
        <section class="questions-paragraph">
          <h4 id="article2" class="questions-paragraph-title">
          ...
          >
            ...
            <p class="questions-paragraph-text">
              ...
              out to you (typically on the same business day). In most cases we
              can transfer the domain to your preferred registrar (such as
          ...
          >
            ...
            <p class="questions-paragraph-text">
              ...
              purchase a domain on a payment plan, we hold the domain in an
              Escrow account until it is fully paid off. However our team can
              assist you with making any changes to the domains (such as
              Nameserver changes), so that you can start using the domain right
        ...
        <section class="questions-paragraph">
          <h4 id="article3" class="questions-paragraph-title">
            Managed Contests
          </h4>
        ...
        <section class="questions-paragraph">
          <h4 id="article4" class="questions-paragraph-title">
            For Creatives
          </h4>
          ...
          >
            ...
            <p class="questions-paragraph-text">
              ...
              your overall quality of submissions. Based upon the quality of
              your submissions, you will continue to be assigned additional
              contests. Once you have received enough high ratings on your
              submissions, your account will be upgraded to 'Full Access', so
              that you can begin participating in all open contests.
            </p>
          </article>
          <article
            class="questions-paragraph-point accordeon"
      ...
      <div class="search-container">
        <section class="search-container-section">
          ...
          <nav class="search-nav">
            ...
            <div class="search-nav-livk">
              <a
                class="search-link-text"
      ...
      <footer class="footer-menu-container">
        <div
          class="footer-menu-block accordeon"
          onClick={(e) => e.currentTarget.classList.toggle('active')}
        >
          ...
          <ul class="footer-menu-ul">
            ...
            <li class="footer-menu-li">
              <a class="footer-menu-link" href="https://www.atom.com/logos">
                Logo Contests
              </a>
            </li>
            <li class="footer-menu-li">
              <a class="footer-menu-link" href="https://www.atom.com/taglines">
                Tagline Contests
              </a>
            </li>
            <li class="footer-menu-li">
        ...
        >
          ...
          <ul class="footer-menu-ul">
            ...
            <li class="footer-menu-li">
              <a class="footer-menu-link" href="https://www.atom.com/blog/">
                Branding Blog
              </a>
            </li>
            <li class="footer-menu-li">
            ...
            <li class="footer-menu-li">
              <a class="footer-menu-link" href="https://www.atom.com/startups">
                Startup Toolkit
              </a>
            </li>
            <li class="footer-menu-li">
        ...
        <div class="footer-menu-block">
          ...
          >
            ...
            <ul class="footer-menu-ul">
              ...
              <li class="footer-menu-li">
                <a class="footer-menu-link" href="https://discussion.atom.com/">
                  Discussion Forum
                </a>
              </li>
            </ul>
          ...
          >
            ...
            <ul class="footer-menu-ul">
              ...
              <li class="footer-menu-li">
                <a class="footer-menu-link" href="https://www.atom.com/winners">
                  Recent Winners
                </a>
              </li>
              <li class="footer-menu-li">
        ...
        <div class="footer-menu-block">
          ...
          >
            ...
            <ul class="footer-menu-ul">
              <li class="footer-menu-li">
                <a class="footer-menu-link" href="https://www.atom.com/AboutUs">
                  About
                </a>
              </li>
              <li class="footer-menu-li">
              ...
              <li class="footer-menu-li">
                <a class="footer-menu-link" href="https://helpdesk.atom.com/">
                  Help & FAQs
                </a>
              </li>
              <li class="footer-menu-li">
                <a class="footer-menu-link" href="https://www.atom.com/connect">
                  AtomConnect
                </a>
              </li>
            </ul>
      ...
      <footer class="footer-container">
        ...
        <div class="footer-container-block excellent-bassed">
          <div class="footer-container-exellent">
            ...
            <p class="footer-star-text">
              <img
                class="footer-excellent-star-green"
          ...
          <div class="footer-container-rating">
            <span class="footer-rating-numbers">
              <em>4.7 /5</em>
            </span>
        ...
        <div class="footer-container-block">
          <div class="footer-container-button">
            <a class="footer-consent-text" href="">
              Consent Preferences
            </a>
          </div>
          <div class="footer-container-contact">
            ...
            <a class="footer-contact-icon" href="https://twitter.com/squadhelp">
              <img
