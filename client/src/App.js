...
import PrivateHoc from './components/PrivateHoc/PrivateHocHook';
import NotFound from './components/NotFound/NotFound';
import Home from './pages/Home/Home';
import OnlyNotAuthorizedUserHoc from './components/OnlyNotAuthorizedUserHoc/HocForLoginSignUpHook';
      ...
      <Router history={browserHistory}>
        ...
        <Switch>
          ...
          <Route
            exact
            path="/moderator"
            component={PrivateHoc(ModeratorPage)}
          />
