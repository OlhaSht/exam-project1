...
export const getDialog = (interlocutorId) =>
  http.get(`/chat/getChat?interlocutorId=${interlocutorId}`);
...
export const approveOfferByModerator = (id) =>
  http.put(`/moderator/approveOfferByModerator/${id}`);
export const rejectOfferByModerator = (id) =>
  http.put(`/moderator/rejectOfferByModerator/${id}`);
