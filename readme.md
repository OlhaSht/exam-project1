...
3. Окремо перепрошую за завдання з верстки ATOM. Сторінка знаходиться в головному меню, у вкладці CONTESTS,HOW IT WORKS.
   завдання було виконане першим з використанням HTML/CSS/JS, а потім перенесене у порект майже таким, як було. Я розумію, що файли завеликі і дуже не зручні для перевірки,тому дуже перепрошую за це.
